...
public class ForumAdminController {
    ...
    private void refreshDashboard() {
        ...
        System.out.println("DEBUG: Interaction Stats: " + stats); // Debugging

        if (stats.isEmpty()) {
            System.out.println("DEBUG: No interaction stats found.");
        }
        ...
        System.out.println("DEBUG: Post Count: " + postCount); // Debugging

 ...
 * Column names match exactly: businessPlanID, marketAnalysis, valueProposition, etc.
 */
public class BusinessPlan {
    ...
    public void setBusinessPlanID(int id) { this.businessPlanID = id; }
    ...
    public String getFinancialForecast() { return financialForecast; }
    public void setFinancialForecast(String financialForecast) { this.financialForecast = financialForecast; }

    public Double getFundingRequired() { return fundingRequired; }
    public void setFundingRequired(Double fundingRequired) { this.fundingRequired = fundingRequired; }
    ...
    public String toString() {
        return "BusinessPlan{id=" + businessPlanID + ", title='" + title + "', status='" + status + "'}";
    }
}

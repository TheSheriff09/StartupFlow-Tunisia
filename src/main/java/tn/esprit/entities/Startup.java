...
public class Startup {
    ...
    public void setLastEvaluationDate(LocalDate d) { this.lastEvaluationDate = d; }
    ...
    public String getIncubatorProgram() { return incubatorProgram; }
    public void setIncubatorProgram(String p) { this.incubatorProgram = p; }

    public Integer getFounderID() { return founderID; }
    public void setFounderID(Integer founderID) { this.founderID = founderID; }

    public Integer getBusinessPlanID() { return businessPlanID; }
    public void setBusinessPlanID(Integer businessPlanID) { this.businessPlanID = businessPlanID; }

    @Override
    public String toString() {
        return "Startup{id=" + startupID + ", name='" + name + "', sector='" + sector + "'}";
    }
}
